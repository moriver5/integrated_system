 ...
 */
	...
	if( $_SERVER['HOSTNAME'] == 'dev-php01' ){
		$const = [
			'mail_from'						=> 'info@dev.jra-yosou.net',
			'replay_to_mail'				=> 'info@dev.jra-yosou.net',
			'return_path_to_mail'			=> 'failmail@dev.jra-yosou.net',
			'base_url'						=> 'https://dev.jra-yosou.net',
			'base_admin_url'				=> 'http://dev.site-operation.net/admin',
			'base_agency_url'				=> 'http://dev.site-operation.net/agency',
			'settlement_success_link_url'	=> 'https://dev.jra-yosou.net/member/settlement/done',
			'axes_success_link_text'		=> '購入ページへ戻る',
			'axes_failure_link_url'			=> 'https://dev.jra-yosou.net/member/settlement',
	...
	//本番環境
		...
		$const = [
			'mail_from'						=> 'info@jra-yosou.net',
			'replay_to_mail'				=> 'info@jra-yosou.net',
			'return_path_to_mail'			=> 'failmail@jra-yosou.net',
			'base_url'						=> 'https://jra-yosou.net',
			'base_admin_url'				=> 'https://jra-yosou.net/admin',
			'base_agency_url'				=> 'https://jra-yosou.net/agency',
			'settlement_success_link_url'	=> 'https://jra-yosou.net/member/settlement/done',
			'axes_success_link_text'		=> '購入ページへ戻る',
			'axes_failure_link_url'			=> 'https://jra-yosou.net/member/settlement',
			'axes_failure_link_text'		=> '購入ページへ戻る',
			'list_site_const'				=> [
				'dev.jra-yosou.net'			=> 'jray',
				'dev.keirin-yosou.com'		=> 'kriy',
...
return array_merge($const, [
	...
	'html_admin_title'				=> 'GOLDEN★STARS(ゴールデン★スターズ) 管理',
	'disp_mobile_domain'			=> [
		'docomo.ne.jp',
		'ezweb.ne.jp',
		'i.softbank.jp',
	...
	'aexs_credit_client_ip'				=> '1011004040',	//axes
	'telecom_credit_client_ip'			=> '00429',			//telecom
	'credix_credit_client_ip'			=> '',				//credix
...
//		'222.151.205.105'			//本番環境でテストするとき：社内IP？
	...
	'artisan_command_path'			=> '/usr/bin/php /data/www/jray/artisan',
	'view_file_extension'			=> '.blade.php',
	'project_home_path'				=> '/data/www/jray',
	'project_home_match'			=> '\/data\/www\/jray',
	...
	'top_content_images_full_path'	=> '/data/www/jray/public/images/top_content',
	...
	'sendid_length'					=> 25,
	'telecomcredit_sendid_length'	=> 16,
...
//		'remember_token',
	 ...
	 * 
	 */
	'save_upload_img_file_dir'			=> '/data/www/jray/public/images/',
	
	
	/*
	 * 顧客データのインポート
	 */
	'save_import_file_dir'				=> '/data/www/jray/storage/upload/',
	 ...
	 * ログ関連
	 */
	'payment_log_dir_path'				=> '/data/www/jray/storage/logs/payment_log/',
	'system_log_dir_path'				=> '/data/www/jray/storage/logs/syslogs/',
	'client_log_dir_path'				=> '/data/www/jray/storage/logs/client_logs/',
	...
	//管理用
	'mail_admin_from_name'			=> 'GOLDEN★STARS 運営管理',
	'mail_admin_info_subject'		=> '【GOLDEN★STARS 運営管理】です。',
