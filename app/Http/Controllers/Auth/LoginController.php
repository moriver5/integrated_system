	...
	*/
	...
	protected function validateLogin(Request $request)
	{
		$this->validate($request, [
			$this->username() => 'bail|required|string|max:'.config('const.login_id_max_length').'|exists:'.Session::get('operation_select_db').'.users|check_regist_status',
...
//			return $this->sendLoginResponse($request);
			return redirect('/member/home/'.$user->remember_token);
		}
		...
		return redirect('/sp/login')->withInput();
