...
class AxesPaymentController extends Controller
{
	 ...
	 */
	public function axesCreditPaymentResponse(Request $request)
	{
		$listResonse = [];
...
//error_log($user_db_data->login_id.":".$user_db_data->pay_count.":error\n",3,"/data/www/jray/storage/logs/nishi_log.txt");
	 ...
	 */
	public function axesNetbankPaymentResponse(Request $request)
	{
		//現在の時刻を取得
		$now_date = Carbon::now();
