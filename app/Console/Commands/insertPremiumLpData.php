...
class insertPremiumLpData extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'insert:lp {csvfile1} {csvfile2} {dbname}';
    ...
    {
        $csvfile1 = $this->argument("csvfile1");
        $csvfile2 = $this->argument("csvfile2");
