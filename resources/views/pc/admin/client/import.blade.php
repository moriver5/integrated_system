...
-->
								<td style="width:500px;vertical-align:middle;padding:5px;">
									<input id="ad_cd" data-placement="bottom" data-html="true" type="text" name="ad_cd" value="" placeholder="広告コードがある場合はここに入力してください" size="20" class="form-control" style="height:29px;margin-top:3px;" autofocus>
								</td>
							</tr>
							<tr style="text-align:center;padding:10px;">
<!--
