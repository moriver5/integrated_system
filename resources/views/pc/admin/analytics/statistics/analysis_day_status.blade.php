        ...
        <div class="col-md-9 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-heading" style="font:normal 12px/120% 'メイリオ',sans-serif;text-align:center;">
					<b><a href="/admin/member/analytics/statistics/access/order/status/{{ $year }}/{{$prev_month}}/{{$prev_day}}">PREV</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/admin/member/analytics/statistics/access/{{ $year }}">{{ $year }}</a>年{{ $month }}月{{ $day }}日&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/admin/member/analytics/statistics/access/order/status/{{ $year }}/{{$next_month}}/{{$next_day}}">NEXT</a></b>
				</div>
							...
							@foreach($db_data as $lines)
								<tr style="font:12px/120% 'メイリオ',sans-serif;">
									...
									<td style="padding:3px;text-align:center;">
										<a href="/admin/member/client/edit/{{ $db_data->currentPage() }}/{{ $lines->client_id }}">{{ $lines->mail_address }}</a>
									</td>
									<td style="padding:3px;text-align:center;">
