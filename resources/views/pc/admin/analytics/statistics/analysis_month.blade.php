        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-heading" style="font:normal 12px/120% 'メイリオ',sans-serif;text-align:center;">
					<b><a href="/admin/member/analytics/statistics/access/{{ $year }}/{{$prev_month}}">PREV</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/admin/member/analytics/statistics/access/{{ $year }}">{{ $year }}</a>年{{ $month }}月&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/admin/member/analytics/statistics/access/{{ $year }}/{{$next_month}}">NEXT</a></b>
				</div>
							...
							@foreach($db_data as $day => $lines)
								<tr style="font:12px/120% 'メイリオ',sans-serif;">
									<td style="padding:3px;text-align:center;" class="pay">
										<a href="/admin/member/analytics/statistics/access/{{ $year }}/{{ $month }}/{{ $day }}">{{ $day }}日</a>
									</td>
									...
									<td style="padding:3px;text-align:center;" class="may_count">
										...
										<a href="/admin/member/analytics/statistics/access/order/status/{{ $year }}/{{ $month }}/{{ $day }}">{{ number_format($lines['order_count']) }}</a>
										@else
											0
										@endif
									</td>
