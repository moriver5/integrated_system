        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-heading" style="font:normal 12px/120% 'メイリオ',sans-serif;text-align:center;">
					<b><a href="/admin/member/analytics/event/{{$prev_year}}">PREV</a>&nbsp;&nbsp;|&nbsp;&nbsp;{{ $year }}年&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/admin/member/analytics/event/{{$next_year}}">NEXT</a></b>
				</div>
					...
					@if( !empty($db_data) )
						...
						<table border="1" align="center" style="width:100%;">
							...
							@foreach($db_data as $month => $lines)
								<tr style="font:12px/120% 'メイリオ',sans-serif;">
									<td style="padding:3px;text-align:center;" class="pay">
										<a href="/admin/member/analytics/event/{{ $year }}/{{ $month }}">{{ $month }}月</a>
									</td>
							...
							<tr style="background-color:gray;">
								<td style="padding:1px;" colspan="12"></td>
							</tr>
