        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-heading" style="font:normal 12px/120% 'メイリオ',sans-serif;text-align:center;">
					<b><a href="/admin/member/analytics/sales/summary/{{ $year }}/{{$prev_month}}">PREV</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/admin/member/analytics/sales/summary/{{ $year }}">{{ $year }}</a>年{{ $month }}月&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/admin/member/analytics/sales/summary/{{ $year }}/{{$next_month}}">NEXT</a></b>
				</div>
...
$(document).ready(function(){
	...
	@foreach($db_data as $days => $lines)
		listDays[listDays.length] = '{{$days}}';
