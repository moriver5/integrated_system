        ...
        <div class="col-md-2 col-md-offset" style="width:99%;">
            <div class="panel panel-default">
                <div class="panel-heading" style="font:normal 13px/130% 'メイリオ',sans-serif;">
					<b>メール配信&nbsp;&nbsp;&nbsp;&nbsp;<font color="blue">予想ID【 {{ $id }} 】</font></b>
                ...
                <div class="panel-body">
                    <form id="formEditMail" class="form-horizontal" method="POST" action="/admin/member/forecast/access/mail/send">
						{{ csrf_field() }}
						<center>
								...
								<div class="form-group" style="align:center;">
									<table border="1" width="95%">
										...
										<tr style="text-align:center;">
											...
											<td>
												<input type="text" name="from_name" class="form-control" value="{{ config('const.html_title') }}" placeholder="送信者名">
											</td>
										</tr>
										<tr style="text-align:center;">
											<td>
