								...
								<div class="form-group" style="align:center;">
									...
									<table border="1" width="95%">
										<tr style="text-align:center;background:wheat;font-weight:bold;">
											...
											<td style="padding:1px 0px;">グループ名</td>
											<td style="padding:1px 0px;">説明</td>
										...
										<tr class="slt_group" id="slt_group{{ $lines->id }}" style="text-align:center;">
											...
											<td><input type="text" class="group_data" id="group{{ $lines->id }}" name="group[]" value="{{ $lines->name }}" size="57" maxlength="{{ config('const.group_name_max_length') }}"></td>
											<td><input type="text" name="memo[]" id="memo{{ $lines->id }}" value="{{ $lines->memo }}" size="57" maxlength="{{ config('const.group_memo_max_length') }}"></td>
