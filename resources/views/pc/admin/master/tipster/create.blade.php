        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
					...
					<form id="formTipster" class="form-horizontal" method="POST" action="/admin/member/master/tipster/setting/create/send">
						{{ csrf_field() }}
                        <div class="form-group{{ $errors->has('contents') ? ' has-error' : '' }}">
							<div class="col-md-12">
								<table width="100%">
									...
									<tr>
										<td colspan="2" style="text-align:center;font-weight:bold;">
											予想師の名前 <input type="text" name="name" class="form-control">
										</td>
									</tr>
									<tr>
										<td>&nbsp;</td>
									...
									<tr>
										<td colspan="2" style="text-align:center;font-weight:bold;">
											<textarea id="contents" cols="40" rows="10" class="form-control" style="font:normal 17px/120% 'メイリオ',sans-serif;" name="contents" placeholder="" autofocus></textarea>
										</td>
									</tr>
								</table>
