        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="formGrantPoint" class="form-horizontal" method="POST" action="/admin/member/master/info/create/send">
                        {{ csrf_field() }}
								...
								<table width="100%">
									...
									<tr>
										<td style="text-align:center;font-weight:bold;">
											<textarea id="userinfo" cols="40" rows="10" class="form-control" style="font:normal 17px/120% 'メイリオ',sans-serif;" name="userinfo" placeholder="" autofocus>
<div id="userinfo<!--index-->" class="white-popup disptime_<!--disptime-->">
	このタグの中に書いてください
</div>
											</textarea>
										</td>
