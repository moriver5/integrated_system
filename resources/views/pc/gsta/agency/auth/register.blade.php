        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="formCreate" class="form-horizontal" method="POST" action="/agency/regist/send">
                        {{ csrf_field() }}
<!--
...
-->
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" placeholder="登録したメールアドレスがログインIDとなります" required autofocus>
