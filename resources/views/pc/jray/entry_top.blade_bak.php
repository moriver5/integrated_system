...
<p class="user_address"><input type="email" name="mail_address" placeholder="メールアドレスを入力(半角英数字)"></p>
...
<p class="pay">￥394,650</p>
<p class="campaign">『真田　浩』</p>
<p class="race">福島4R 3連単</p>
</li>
<li>
<p class="date">2020-03-08</p>
<figure><img src="/sample/hitcpimg_01.png" alt="予想師"></figure>
...
<ul class="list_voice">
<li class="js_inview animated_fadeInUp"><dl>
<dt>投稿日時　2020-03-02</dt>
<dd>今月かなり稼がせてもらってるけど、先週は忙しくて参加できませんでした。出たんですね～。悔しい…その精度からも、御社の情報の信頼性が分かります。これからも宜しくお願いします。</dd>
</dl></li>
<li class="js_inview animated_fadeInUp"><dl>
<dt>投稿日時　2020-03-02</dt>
<dd>魂の3連単12点情報にて49万的中ありがとうございました。割と数万円プラスになればいいかなと思ってたのですが大幅にプラスになったので来週も頼みます</dd>
</dl></li>
<li class="js_inview animated_fadeInUp"><dl>
<dt>投稿日時　2020-03-02</dt>
<dd>これだけ当たる無料情報ないよｗほんとに凄いですねｗ御社の凄さが確信に変わりました！キャンペーン情報次全部入りますｗ</dd>
</dl></li>
<li class="js_inview animated_fadeInUp"><dl>
<dt>投稿日時　2020-03-02</dt>
<dd>正直、情報料を支払った後はかなり不安、というか若干後悔していました。魅力だけど、万が一、万が一にも全部不的中だったら…御社を信じて馬券を購入してました。結果は本当にすごかった。信じてよかった。</dd>
</dl></li>
<li class="js_inview animated_fadeInUp"><dl>
<dt>投稿日時　2020-03-02</dt>
<dd>不的中の時もあるけど、昨日は完璧でしたね。鳥肌ものでした。参加人数が増えると払戻も減るので友達には絶対にナイショにしてます。御社もあまり広告を賭けないで下さい。</dd>
</dl></li>
<li class="js_inview animated_fadeInUp"><dl>
<dt>投稿日時　2020-03-02</dt>
<dd>土曜は金銭の都合で200円投資しかできませんでしたがそれでも50万円になりました。日曜は500円投資だったので本当に助かりました。借金が少し軽くなりました。</dd>
</dl></li>
</ul><!--/.list_voice-->
</div><!--/.inner-->
</section><!--.block_voice-->
