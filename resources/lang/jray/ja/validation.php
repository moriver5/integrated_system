    ...
    */
    'custom' => [
		...
		'ad_cd' => [
			...
			'check_alpha_dash'	 => ':attributeには半角英数字と-_.のみからなる文字列を入力してください',
		],
		'del' => [
		...
		'name'			 => [
			'required'				=> ':attributeを入力してください。',
			'check_user_login_id'	=> ':attributeは半角数字6桁を入力してください',
			'check_exist_login_id'	=> 'その:attributeは既に使用されています。他のログインIDを入力してください',
		],
        'attribute-name' => [
		...
		'tel' => [
 		...
 		'msg3' => [
			'required'				 => ':attributeを入力してください。',
			'digital_num_check'		 => ':attributeには半角数字のみで入力してください。',
			'surrogate_pair_check'	 => ':attributeに使用できない文字が含まれています。',
			'emoji_check'			 => ':attributeに絵文字は使用できません。',
		],
 		'race_name' => [
